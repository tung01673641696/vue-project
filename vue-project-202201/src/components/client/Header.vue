<template>
  <div class="header">
    <div class="header__top container">
      ...
      <!-- hadle Search -->
      <form @submit.prevent="directSearch()" class="search__form">
        <BaseInput
          type="text"
      ...
      <div class="header__option">
        <div @click="showUserOption = !showUserOption">
          <div v-if="isAuthenticated" class="user__information">
            <svg
              id="user_icon"
            ...
            <div v-if="showUserOption" id="user_option" class="option">
          ...
          >
            ...
            <div v-if="showAuthOption" id="auth_option" class="option">
              <ul>
    ...
    <div class="header__navbar container">
      <Dropdown title="Tất cả danh mục" :items="categories" />
      <div class="header__navbar--list">
        <ul>
          ...
          <li>
            <router-link class="router-link" to="/new-products"
              >Sản phẩm mới</router-link
            >
          </li>
          <li>
            <router-link class="router-link" to="/hot-products"
              >Sản phẩm hot</router-link
            >
          </li>
          <li>
            <router-link class="router-link" to="/sale-products"
              >Sản phẩm giảm giá</router-link
            >
          </li>
          <li>
            <router-link class="router-link" to="/news">Tin tức</router-link>
          </li>
          <li>
          ...
          <li>
            <router-link class="router-link" to="/contact">Liên hệ</router-link>
          </li>
        </ul>
      </div>
    </div>
