        ...
        <div class="product_info">
          ...
          <div class="info">
            ...
            <div class="info_price">
              ...
              <p :hidden="!product.sale" class="price_sale">
            ...
            <div hidden class="quantity_error">
              <p>Số lượng bạn chọn đã đạt mức tối đa của sản phẩm này</p>
            </div>

            <div class="add_to_cart">
              <BaseButton class="red sm" text="Thêm vào giỏ" />

              <BaseButton class="red sm" text="Thanh toán" />
            </div>
          </div>
          ...
          <div class="express_logo">
            ...
            <img src="@/assets/images/logo-express.png" alt="" />
          </div>
        </div>
      </div>
    </div>
